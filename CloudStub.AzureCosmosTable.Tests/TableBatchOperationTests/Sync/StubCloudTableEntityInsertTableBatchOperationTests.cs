    ...
    public class StubCloudTableEntityInsertTableBatchOperationTests : BaseStubCloudTableTests
    {
        ...
        public void Execute_WhenTableDoesNotExist_ThrowsException()
        {
            ...
            var exception = Assert.Throws<StorageException>(
                () => CloudTable.ExecuteBatch(new TableBatchOperation { TableOperation.Insert(testEntity) })
            );
        ...
        public void Execute_InsertOperationWhenEntityAlreadyExists_ThrowsException()
        {
            ...
            var exception = Assert.Throws<StorageException>(
                () => CloudTable.ExecuteBatch(new TableBatchOperation { TableOperation.Insert(new TableEntity("partition-key", "row-key")) })
            );
        ...
        public void TableOperation_InsertOperationWhenEchoContentIsFalse_HasNoEffect()
        {
            ...
            var tableResults = CloudTable.ExecuteBatch(new TableBatchOperation { TableOperation.Insert(new TableEntity("partition-key", "row-key"), echoContent: false) });
        ...
        public void Execute_WhenPartitionKeyIsNull_ThrowsException()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(
                () => CloudTable.ExecuteBatch(new TableBatchOperation { TableOperation.Insert(new TableEntity(null, "row-key")) })
            );
        ...
        public void Execute_WhenRowKeyIsNull_ThrowsException()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(
                () => CloudTable.ExecuteBatch(new TableBatchOperation { TableOperation.Insert(new TableEntity("partition-key", null)) })
            );
