    ...
    public class StubCloudTableEntityReplaceTableBatchOperationTests : BaseStubCloudTableTests
    {
        ...
        public void Execute_WhenTableDoesNotExist_ThrowsException()
        {
            ...
            var exception = Assert.Throws<StorageException>(
                () => CloudTable.ExecuteBatch(new TableBatchOperation { TableOperation.Replace(testEntity) })
            );
        ...
        public void Execute_WhenETagsIsWildcard_ReplacesEntity()
        {
            ...
            var tableResults = CloudTable.ExecuteBatch(new TableBatchOperation { TableOperation.Replace(updatedTestEntity) });
        ...
        public void Execute_WhenETagsMismatch_ThrowsException()
        {
            ...
            var exception = Assert.Throws<StorageException>(
                () => CloudTable.Execute(TableOperation.Replace(updatedTestEntity))
            );
