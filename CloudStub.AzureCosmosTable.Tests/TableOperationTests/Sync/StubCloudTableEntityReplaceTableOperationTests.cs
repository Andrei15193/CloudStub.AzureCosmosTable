...
namespace CloudStub.AzureCosmosTable.Tests.TableOperationTests.Sync
{
    public class StubCloudTableEntityReplaceTableOperationTests : BaseStubCloudTableTests
    {
        ...
        public void Execute_WhenTableDoesNotExist_ThrowsException()
        {
            ...
            var exception = Assert.Throws<StorageException>(() => CloudTable.Execute(TableOperation.Replace(testEntity)));
        ...
        public void Execute_WhenETagsIsWildcard_ReplacesEntity()
        {
            ...
            var tableResult = CloudTable.Execute(TableOperation.Replace(updatedTestEntity));
        ...
        [Fact]
        public void Execute_WhenETagsMatch_ReplacesEntity()
        {
            var testEntity = new TestEntity
            {
                PartitionKey = "partition-key",
            ...
            tableResult = CloudTable.Execute(TableOperation.Replace(updatedTestEntity));
        ...
        [Fact]
        public void Execute_WhenDynamicEntityHasNullProperties_TheyAreRemoved()
        {
            CloudTable.Create();
            ...
            CloudTable.Execute(TableOperation.Replace(new DynamicTableEntity
            {
                PartitionKey = "partition-key",
                RowKey = "row-key",
                ETag = tableResult.Etag,
        ...
        public void Execute_WhenETagsMismatch_ThrowsException()
        {
            ...
            var exception = Assert.Throws<StorageException>(() => CloudTable.Execute(TableOperation.Replace(updatedTestEntity)));
        ...
        public void Execute_WhenPartitionKeyIsNull_ThrowsException()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(
                ...
                () => CloudTable.Execute(TableOperation.Replace(testEntity))
            );
